...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkredvarselGarminWeb.Entities.Agreement", b =>
                {
                    ...
                    b.Property<string>("WatchKey")
                        .HasColumnType("text")
                        .HasColumnName("watch_key");
            ...
            modelBuilder.Entity("SkredvarselGarminWeb.Entities.StripeCheckoutSessionFulfillment", b =>
                {
                    ...
                    b.HasKey("SessionId")
                        .HasName("pk_stripe_checkout_session_fulfillments");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_stripe_checkout_session_fulfillments_user_id");

                    b.ToTable("stripe_checkout_session_fulfillments", (string)null);
                });
            ...
            modelBuilder.Entity("SkredvarselGarminWeb.Entities.SubscriptionSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");

                    b.Property<int>("FormerSubscriberExtraMonths")
                        .HasColumnType("integer")
                        .HasColumnName("former_subscriber_extra_months");

                    b.HasKey("Id")
                        .HasName("pk_subscription_settings");

                    b.ToTable("subscription_settings", (string)null);
            ...
            modelBuilder.Entity("SkredvarselGarminWeb.Entities.StripeCheckoutSessionFulfillment", b =>
                {
                    b.HasOne("SkredvarselGarminWeb.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_stripe_checkout_session_fulfillments_users_user_id");
